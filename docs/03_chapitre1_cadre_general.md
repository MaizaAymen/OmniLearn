...
- **Student:** joins classes; solves coding problems; submits code; works on assignments; chats in conversations; uses the PDF assistant on course material; follows a personalized roadmap.
