...
### 1. Project Gantt chart — release plan over four sprints
...
```mermaid
gantt
    title Figure 5.1 — OmniLearn release roadmap (4 sprints × 4 weeks)
...
<p align="center"><em><strong>Figure 5.1</strong> — OmniLearn release roadmap (4 sprints × 4 weeks).</em></p>
